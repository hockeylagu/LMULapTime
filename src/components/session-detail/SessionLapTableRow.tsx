    ...
    >
      ...
      <td className="px-3 py-2.5 text-center font-sans">
        <button
          ...
          className="px-2.5 py-1 rounded-lg bg-lmu-bg hover:bg-lmu-accent hover:text-white text-lmu-muted border border-lmu-border text-[11px] font-semibold transition-all flex items-center gap-1 mx-auto cursor-pointer"
