...
export const TelemetryTirePressuresChannel: React.FC<TelemetryTirePressuresChannelProps> = React.memo(({
  ...
  const chartSvg = useMemo(() => (
    <svg viewBox="0 0 1000 100" preserveAspectRatio="none" className="w-full h-full">
      ...
      {baselineTirePressuresPaths?.fl && (
        <path d={baselineTirePressuresPaths.fl} fill="none" stroke="#06b6d4" strokeWidth="1" strokeDasharray="3 3" vectorEffect="non-scaling-stroke" opacity="0.6" />
      )}
      {baselineTirePressuresPaths?.fr && (
        <path d={baselineTirePressuresPaths.fr} fill="none" stroke="#3b82f6" strokeWidth="1" strokeDasharray="3 3" vectorEffect="non-scaling-stroke" opacity="0.6" />
      )}
      {baselineTirePressuresPaths?.rl && (
        <path d={baselineTirePressuresPaths.rl} fill="none" stroke="#f59e0b" strokeWidth="1" strokeDasharray="3 3" vectorEffect="non-scaling-stroke" opacity="0.6" />
      )}
      {baselineTirePressuresPaths?.rr && (
        <path d={baselineTirePressuresPaths.rr} fill="none" stroke="#f43f5e" strokeWidth="1" strokeDasharray="3 3" vectorEffect="non-scaling-stroke" opacity="0.6" />
      )}

      {/* Primary solid lines */}
      {tirePressuresPaths.fl && <path d={tirePressuresPaths.fl} fill="none" stroke="#06b6d4" strokeWidth="1.3" vectorEffect="non-scaling-stroke" strokeLinecap="round" />}
      {tirePressuresPaths.fr && <path d={tirePressuresPaths.fr} fill="none" stroke="#3b82f6" strokeWidth="1.3" vectorEffect="non-scaling-stroke" strokeLinecap="round" />}
      {tirePressuresPaths.rl && <path d={tirePressuresPaths.rl} fill="none" stroke="#f59e0b" strokeWidth="1.3" vectorEffect="non-scaling-stroke" strokeLinecap="round" />}
      {tirePressuresPaths.rr && <path d={tirePressuresPaths.rr} fill="none" stroke="#f43f5e" strokeWidth="1.3" vectorEffect="non-scaling-stroke" strokeLinecap="round" />}
    </svg>
  ...
  return (
    <div className="relative flex-1 basis-0 min-h-[72px] border-b border-lmu-border/40 group bg-[#09111c]/60">
      ...
      {isCursorInView && hasData && tp && (
        ...
        >
          <div className="px-2 py-0.5 rounded-md bg-[#070c18] border border-sky-500/80 font-mono font-bold text-[10px] shadow-[0_2px_10px_rgba(0,0,0,0.85)] flex items-center gap-1.5 whitespace-nowrap">
