...
export const TelemetrySocChannel: React.FC<TelemetrySocChannelProps> = React.memo(({
  ...
  return (
    <div className="relative flex-1 basis-0 min-h-[68px] border-b border-lmu-border/40 group bg-[#1d1606]/50">
      ...
      <div className="absolute inset-0 flex flex-col justify-between py-2 px-3 pointer-events-none opacity-20">
        <div className="border-b border-amber-400/30 w-full text-[9px] text-amber-300 font-mono">100%</div>
        <div className="border-b border-amber-400/30 w-full text-[9px] text-amber-300 font-mono">50%</div>
        <div className="border-b border-amber-400/30 w-full text-[9px] text-amber-300 font-mono">0%</div>
      </div>
