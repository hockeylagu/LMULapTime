...
export const TelemetryRegenRateChannel: React.FC<TelemetryRegenRateChannelProps> = React.memo(({
  ...
  return (
    <div className="relative flex-1 basis-0 min-h-[68px] border-b border-lmu-border/40 group bg-[#160c23]/50">
      ...
      {isCursorInView && hasRegenData && (
        ...
        >
          <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-black/90 text-purple-300 border border-purple-500/40 shadow-sm">
