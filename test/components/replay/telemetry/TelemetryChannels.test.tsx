...
describe('TelemetryChannelRenderer & Preset Rows', () => {
  ...
  it('renders WHEEL / TIRE badge in TelemetryPresetChannelRow for wheel category channels', async () => {
    const { TelemetryPresetChannelRow } = await import('../../../../src/components/replay/telemetry/presets/TelemetryPresetChannelRow.js');
    const { AVAILABLE_TELEMETRY_CHANNELS } = await import('../../../../src/components/replay/telemetry/presets/telemetryPresets.js');
  ...
  it('renders ENERGY / FUEL badge in TelemetryPresetChannelRow for energy category channels', async () => {
    const { TelemetryPresetChannelRow } = await import('../../../../src/components/replay/telemetry/presets/TelemetryPresetChannelRow.js');
    const { AVAILABLE_TELEMETRY_CHANNELS, DEFAULT_TELEMETRY_PRESETS } = await import('../../../../src/components/replay/telemetry/presets/telemetryPresets.js');
